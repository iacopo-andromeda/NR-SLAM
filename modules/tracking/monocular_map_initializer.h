...
class MonocularMapInitializer {
 public:
  ...
  MonocularMapInitializer(Options& options,
 ...
 private:
  ...
  InitializationResults InitializationRefinement(
      std::vector<cv::KeyPoint>& current_keypoints,
  ...
  InitializationResults BuildInitializationResults(
  ...
  enum InternalStatus { NO_DATA, OK, RECENTLY_RESET };
